...
public enum ExceptionCode {
    ...
    // 401 Unauthorized
    TWEET_USER_MISMATCH(HttpStatus.UNAUTHORIZED, ClientExceptionCode.TWEET_USER_MISMATCH, "허용되지 않은 계정의 접근입니다."),
    ...
    LIKE_NOT_FOUND(HttpStatus.NOT_FOUND, ClientExceptionCode.LIKE_NOT_FOUND, "좋아요가 존재하지 않습니다."),
